...
class Employee {
    ...
    public void calculateTransportAllowance() {
        System.out.println("Employee Salary before calculating transport allowance: " + basicSalary);
        System.out.println("Transport Allowance: " + transportAllowance);
        double salaryAfterTransportAllowance = basicSalary + transportAllowance;
        System.out.println("Employee Salary after calculating transport allowance: " + salaryAfterTransportAllowance);
    }
}
class Manager extends Employee {
   ...
   // Override
    public void calculateTransportAllowance() {
        ...
        System.out.println("Manager Salary before calculating transport allowance: " + basicSalary);
        System.out.println("Transport Allowance: " + transportAllowance);
        double salaryAfterTransportAllowance = basicSalary + transportAllowance;
        System.out.println("Manager Salary after calculating transport allowance: " + salaryAfterTransportAllowance);
    }
}
